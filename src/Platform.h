#ifndef FLOODENGINE_PLATFORM_H
#define FLOODENGINE_PLATFORM_H
...
#define VERSION_MINOR(version) (((uint32_t)(version) >> 12) & 0x3FFU)
#define VERSION_PATCH(version) ((uint32_t)(version) & 0xFFFU)


#define ENGINE_NAME "Flood Engine"
...
#define APPLICATION_VERSION MAKE_VERSION(1, 0, 0)
